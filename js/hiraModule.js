var hiraModule = (function() {
    ...
    hira.showResult = function(result) {
        switch (result) {
            case 1:
                $("#hira_contain #resultLabel").removeClass("text-danger").addClass("text-success").text("OK");
            ...
            case 2:
                $("#hira_contain #resultLabel").removeClass("text-success").addClass("text-danger").text("Failed");
                break;

            case 3:
                $("#hira_contain #resultLabel").addClass("text-success").removeClass("text-danger").text("Finished");
                firstWord_div.text("");
                break;
        }
        secondWord_input.val("");
